    ...
    with open(csv_file_path, mode='r', encoding='utf-8') as file:
        ...
        for row in csv_reader:
            ...
            if question_url:
                ...
                subprocess.run(curl_command_question, check=False) # check=False 避免 curl 錯誤時終止程式
            ...
            if answer_url:
                ...
                subprocess.run(curl_command_answer, check=False) # check=False 避免 curl 錯誤時終止程式
